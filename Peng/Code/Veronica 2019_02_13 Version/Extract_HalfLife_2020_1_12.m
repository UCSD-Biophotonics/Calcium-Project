...
root1 = "Z:\Andrew\10032019 Primary Salsa BApta\FOV2 cut at 60 (59)\data\";
root2 = "ROI\";
root = root1 + root2;
filetype = '.csv';
final = zeros(1,2); %creates an empty matrix to be filled later with values
cutindex = 59;%CHANGE the cuts here
for i= 9
    filenum =  "Normalize_TOM_Divide" + cutindex + "Mean" + num2str(i); 
    %
    ...
    plateaurange_time = peaktime + 45;%next_cuttime;
